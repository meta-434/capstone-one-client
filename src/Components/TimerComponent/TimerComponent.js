...
class TimerComponent extends Component {
  ...
  handlePostSubmit = (e) => {
    ...
    this.context.handlePostSession({
      session_name: name,
  ...
  handleSessionContent = (e) => {
    ...
    this.setState({ description: descriptionInput }, () =>
      this.validateContent(descriptionInput)
    );
  };
  ...
  render() {
    ...
    return (
      <>
        <ErrorDisplay />
        <section>
          <header className="timer-header">Session Timer</header>
          {!!this.context.authToken || sessionStorage[`access-token`] ? (
            ...
            <>
              ...
              <br />
              <p>
                You may still use the timer, but you are unable to save sessions
                or notes
              </p>
            </>
          )}
        ...
        {!!this.context.authToken || sessionStorage[`access-token`] ? (
          <>
            <header className="form-header">Submit Session</header>
            <section className="form-and-error">
              <form className="react-form" onSubmit={this.handlePostSubmit}>
                ...
                <button
                  ...
                  type="submit"
                  disabled={
                    !this.state.nameValid || !this.state.descriptionValid
                  }
                >
                  Submit
                </button>
